...
class GmrtUtilites:
    ...
    def runxinfoalldb(self, file_path, obslog_file, observation_no, basename):
        ...
        if get_data('debug_mode','PRINTON') == True: print("RUNXINFOALLDB", file_path, obslog_file, observation_no, basename)
        return outfile
    
    def xinfo(self, file_path):
        if get_data('debug_mode','PRINTON') == True: print("XINFO", file_path)
    ...
    def jxinfo(self, outfile):
        ...
        if get_data('debug_mode','PRINTON') == True: print("JXINO", sql_file)
        return sql_file
